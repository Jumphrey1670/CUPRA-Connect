...
"""Then forked from https://github.com/farfar/seatconnect for adaptation to CUPRA Connect"""
import re
import time
import logging
import asyncio
...
from CUPRAConnect.__version__ import __version__ as lib_version
from CUPRAConnect.utilities import read_config, json_loads
from CUPRAConnect.vehicle import Vehicle
...
class Connection:
  ...
  # API login/logout/authorization
    ...
    async def _signin_service(self, html, authissuer, authorizationEndpoint, client=BRAND):
